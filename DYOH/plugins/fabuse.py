...
from DYOH import ubots, OWNER_ID, SUDO_USERS
...
# Function to handle abuse commands
def register_abuse_commands(ubot):
    @ubot.on(events.NewMessage(pattern=r"randi(?:\s|$)([\s\S]*)", outgoing=True))
    async def randi_cmd(event):
        txt = random.choice(abuse6)
        await event.reply(txt)

    @ubot.on(events.NewMessage(pattern=r"labuse(?:\s|$)([\s\S]*)", outgoing=True))
    async def labuse_cmd(event):
        txt = random.choice(abuse11)
        await event.reply(txt)

    @ubot.on(events.NewMessage(pattern=r"fucked(?:\s|$)([\s\S]*)", outgoing=True))
    async def fucked_cmd(event):
        txt = random.choice(abuse10)
        await event.reply(txt)

    @ubot.on(events.NewMessage(pattern=r"chu(?:\s|$)([\s\S]*)", outgoing=True))
    async def chu_cmd(event):
        txt = random.choice(abuse9)
        await event.reply(txt)

    @ubot.on(events.NewMessage(pattern=r"nooba(?:\s|$)([\s\S]*)", outgoing=True))
    async def nooba_cmd(event):
        txt = random.choice(abuse7)
        await event.reply(txt)

    @ubot.on(events.NewMessage(pattern=r"run(?:\s|$)([\s\S]*)", outgoing=True))
    async def run_cmd(event):
        txt = random.choice(abuse1)
        await event.reply(txt)

    @ubot.on(events.NewMessage(pattern=r"galii(?:\s|$)([\s\S]*)", outgoing=True))
    async def galii_cmd(event):
        txt = random.choice(abuse2)
        await event.reply(txt)

    @ubot.on(events.NewMessage(pattern=r"repe(?:\s|$)([\s\S]*)", outgoing=True))
    async def repe_cmd(event):
        txt = random.choice(abuse3)
        await event.reply(txt)

    @ubot.on(events.NewMessage(pattern=r"chutiya(?:\s|$)([\s\S]*)", outgoing=True))
    async def chutiya_cmd(event):
        txt = random.choice(abuse5)
        await event.reply(txt)

    @ubot.on(events.NewMessage(pattern=r"piro(?:\s|$)([\s\S]*)", outgoing=True))
    async def piro_cmd(event):
        """Abuse command."""
        txt = random.choice(abuse8)
        await event.reply(txt)

    @ubot.on(events.NewMessage(pattern=r"insulted(?:\s|$)([\s\S]*)", outgoing=True))
    async def insulted_cmd(event):
        txt = random.choice(abuse12)
        await event.reply(txt)

    @ubot.on(events.NewMessage(pattern=r"hiabuse(?:\s|$)([\s\S]*)", outgoing=True))
    async def hiabuse_cmd(event):
        txt = random.choice(abuse4)
        await event.reply(txt)

# Register commands for each ubot
for ubot in ubots:
    register_abuse_commands(ubot)